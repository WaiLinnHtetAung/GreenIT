        ...
        <form v-if="!isSending" @submit.prevent = sendMessage>
            <div class="form-data">
                ...
                <div class="form-group">
                    ...
                    label="Select"
                    :items="['Data Center Service and Solution', 'Infrastructure Services & Solutions', 'Security Services & Solution', 'Server & Storage Solution', 'Conferencing & VOIP Solution', 'Server Rental Service', 'Other']"
                    required
                    ></v-select>
                </div>
                <div class="form-group">
                    <label for="">Message</label>
                    <textarea name="" id="" cols="30" rows="3" v-model="formData.message" required></textarea>
                </div>
