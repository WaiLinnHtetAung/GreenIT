    ...
    <div class="footer-section">
        <div class="footer">
            <div class="address">
                ...
                <span>No-1, 3rd-4th Floor, Corner of U Lu Maung Street, and Lower Kyi Myint Daing Road, Kyi Myin Daing Tsp, Yangon, Myanmar</span>
            </div>
            <div class="contact">
            ...
            <div class="social">
                ...
                <div class="social-info">
                    ...
                    <router-link to="#"><i style="color: #e4405f;" class="fa-brands fa-instagram"></i></router-link>
                    <router-link to="#"><i style="color: #0072b1" class="fa-brands fa-twitter"></i></router-link>
